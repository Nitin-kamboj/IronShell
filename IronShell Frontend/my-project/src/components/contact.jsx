...
export function Contact() {
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="pb-24 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-12">
            <div>
              <h2 className="text-2xl font-black italic uppercase text-green-300 mb-6">Location</h2>
              <p className="text-zinc-400 font-bold uppercase tracking-wider text-lg">
                123 Iron Avenue, Industrial District<br />
                Steel City, SC 54321
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-black italic uppercase text-green-300 mb-6">Operating Hours</h2>
            ...
            <div className="p-8 bg-zinc-900/50 border border-zinc-800 rounded-sm md:skew-x-[-3deg]">
              <div className="md:skew-x-[3deg]">
                <h3 className="text-xl font-black italic uppercase text-white">Direct Line</h3>
                <p className="text-green-300 text-2xl font-black mt-2">+1 (555) 000-IRON</p>
                <p className="text-zinc-500 uppercase font-bold text-xs mt-1">support@ironshell.com</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-zinc-900 p-8 md:p-12 border border-zinc-800 shadow-[20px_20px_0px_rgba(187,247,208,0.1)]">
            <form className="space-y-6">
              ...
              <div>
                <label className="block text-xs font-black uppercase tracking-widest text-zinc-500 mb-2">Interest</label>
                <select className="w-full bg-black border border-zinc-800 p-4 text-white focus:outline-none focus:border-green-300 transition-all appearance-none">
              ...
              <button className="w-full py-5 bg-green-300 text-black font-black uppercase tracking-widest hover:bg-white transition-all">
                Send Message
              </button>
            </form>
          </div>
      ...
      <section className="h-96 w-full grayscale contrast-125 brightness-50 border-t border-zinc-800">
          <div className="w-full h-full bg-zinc-900 flex items-center justify-center">
              <p className="text-zinc-700 font-black italic text-4xl uppercase tracking-widest opacity-30">Interactive Map Placeholder</p>
          </div>
      </section>
    </div>
  );
