      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="col-span-1 md:col-span-1">
          ...
          <p className="text-zinc-500 text-sm leading-relaxed font-medium">
            The ultimate training ground for dedicated athletes. We don't just build bodies; we forge legends. Join the shell.
          </p>
          <div className="flex gap-4 mt-6">
            {/* Social Icons Placeholders */}
            {['FB', 'IG', 'TW', 'YT'].map((social) => (
              <a key={social} href="#" className="w-10 h-10 rounded-sm bg-zinc-900 flex items-center justify-center text-xs font-black hover:bg-green-300 hover:text-black transition-all">
                {social}
              </a>
            ))}
          </div>
        ...
        {/* 2. Quick Links */}
        <div>
          <h4 className="text-green-300 font-black italic uppercase tracking-tighter mb-6">Navigation</h4>
        ...
        {/* 3. Contact Info */}
        <div>
          <h4 className="text-green-300 font-black italic uppercase tracking-tighter mb-6">Contact</h4>
          <ul className="space-y-4 text-zinc-400 font-bold text-sm uppercase">
        ...
        {/* 4. Newsletter / CTA */}
        <div>
          <h4 className="text-green-300 font-black italic uppercase tracking-tighter mb-6">Newsletter</h4>
          <p className="text-zinc-500 text-xs font-bold uppercase mb-4">Get training tips & gym updates.</p>
